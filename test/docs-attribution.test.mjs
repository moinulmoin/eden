...
test("documents the supported CLI and clean-room operator boundaries", async () => {
  ...
  for (const document of [readme, packageReadme]) {
    expect(document).toContain("npm install --global @moinulmoin/eden@0.1.3");
    expect(document).toContain("pnpm add --global @moinulmoin/eden@0.1.3");
    expect(document).toContain("bun add --global @moinulmoin/eden@0.1.3");
